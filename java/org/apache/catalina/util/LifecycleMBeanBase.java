...
public abstract class LifecycleMBeanBase extends LifecycleBase
     ...
     * overriding method.
     */
    //设置oname为server/egine/host/context/wrapper
    @Override
    protected void initInternal() throws LifecycleException {
        ...
        // preRegister().
        if (oname == null) {
            //初始化ManagementFactory的platformMBeanServer（MBeanServer）属性
            mserver = Registry.getRegistry(null, null).getMBeanServer();
            //调用上面MBeanServer对象注册当前Mbean对象 server/engine/host/context/wrapper
